...
def serialize_state(state: StateByStepList) -> list:
...
def deserialize_state(payload: Iterable) -> StateByStepList:
...
def log_state(logger: logging.Logger, state: StateByStepList, header: str, level: int = logging.DEBUG) -> None:
