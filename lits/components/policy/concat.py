...
class ConcatPolicy(Policy):
    ...
    def _generate_msg(self, example, state: State, critic: str = None, at_depth_limit=False) -> str:
    ...
    def _get_actions(self, example, state: State,  n_actions, temperature, at_depth_limit, example_idx, critic: str=None, from_phase="") -> list[Action]:
        """ 
        Args:
